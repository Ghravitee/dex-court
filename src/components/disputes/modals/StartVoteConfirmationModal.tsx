// src/components/disputes/modals/StartVoteConfirmationModal.tsx
import { Button } from "../../../components/ui/button";
import { Scale, X } from "lucide-react";
import { AnimatePresence, motion } from "motion/react";
import { useCallback, useState } from "react";

const StartVoteConfirmationModal = ({
    isOpen,
    onClose,
    onConfirm,
    disable,
    ...
    isOpen: boolean;
    onClose: () => void;
    onConfirm: (probono: boolean) => void;  // accept boolean param
    disable?: boolean;
    disputeTitle?: string;
}) => {
                    ...
                    <div className="p-6">
                        <div className="space-y-4">
                            <div className="text-center">
                                ...
                                <p className="text-green-200">Are you sure you want to start the vote?</p>
                                <p className="mt-2 text-sm text-green-200/70">
                                    This action cannot be undone. The dispute will be moved to the vote phase and no further changes can be made.
                                </p>
                            </div>

                            {/* Pro Bono toggle */}
                            <div className="flex items-center justify-center gap-3">
                                <label className="flex items-center gap-2 text-sm text-green-200/90 cursor-pointer select-none">
                                    <input
                                        type="checkbox"
                                        checked={proBono}
                            ...
                            <div className="flex gap-3 pt-4">
                                ...
                                >
                                    ...
                                    {proBono ? "Start Vote (Pro Bono)" : "Start Vote"}
                                </Button>
                            </div>
                        </div>
                    </div>
...
export default StartVoteConfirmationModal;
