...
export const StatsGrid = () => {
  ...
  const stats: Stat[] = useMemo(
    () => [
      ...
      { label: "Eligible Voters", value: 0, icon: Users },
      {
        label: "Agreements",
        value: agreementsLoading ? 0 : agreementsCount,
        icon: Handshake,
      },
      { label: "Platform Revenue", value: 0, icon: Landmark, prefix: "$" },
      { label: "Escrow TVL", value: 0, icon: Banknote, prefix: "$" },
      {
        label: "Active Users",
        value: usersLoading ? 0 : usersCount,
        icon: User,
      },
      { label: "Paid to Judges", value: 0, icon: Coins, prefix: "$" },
      { label: "Paid to Community", value: 0, icon: Wallet, prefix: "$" },
    ],
    [
      agreementsCount,
      agreementsLoading,
