...
> extends HttpClient<SecurityDataType> {
  ...
  /**
   * @description Reject Agreement Delivery This endpoint allows to the other party to reject the delivery. When rejected: - The agreement status reverts to `Active`, allowing further discussion or dispute. - Both parties are notified via Telegram. Rules: - Only the other party can perform this action. - The agreement must currently be in `PartySubmittedDelivery`.
   *
   * @tags Agreement
