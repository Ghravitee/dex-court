...
const StartVoteConfirmationModal = ({
  ...
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void; // removed boolean parameter
  disable?: boolean;
  disputeTitle?: string;
}) => {
            ...
            <div className="space-y-4">
              <div className="text-center">
                ...
                <p className="text-green-200">
                  Are you sure you want to start the vote?
                </p>
                <p className="mt-2 text-sm text-green-200/70">
                  This action cannot be undone. The dispute will be moved to the
                  vote phase and no further changes can be made.
                </p>
              </div>
