...
export const KNOWN_TOKEN_ADDRESSES: Record<string, Record<number, string>> = {
  LAW: {
    ...
    11155111: "0xaE9Ad7F1362E71Dd4C67afF4f9f0E086fe2249cf",
    // 56: "0x",       // BSC
    // 97: "0x697dE18375db7fCc6ad3C95682Cbf4d55CF8ad0c",
    // 8453: "0x",     // Base
    84532: "0x697dE18375db7fCc6ad3C95682Cbf4d55CF8ad0c",
  },
  USDC: {
    ...
    },
    {
      ...
      "inputs": [
        ...
        },
        {
          "name": "outcome",
          "type": "uint8",
          "internalType": "enum AgreementEscrow.DisputeOutcome"
        },
        {
    ...
    },
    {
      ...
      "inputs": [
        ...
        },
        {
          "name": "outcome",
          "type": "uint8",
          "internalType": "enum Voting.DisputeOutcome"
        }
      ],
      "outputs": [],
      "stateMutability": "nonpayable"
